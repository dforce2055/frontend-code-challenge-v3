    ...
    <div class="text-center">
      ...
      <div class="mt-10 flex items-center justify-center gap-x-6">
        <a href="#"
          ...
          @click="onGoBackHome">Go back home</a>
        <a href="mailto:support@support.com" class="text-sm font-semibold text-gray-900"
          @click="onContactSupport">Contact support <span aria-hidden="true">&rarr;</span></a>
      </div>
    </div>
  </main>
</template>
